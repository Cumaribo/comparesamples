# This code is used to compare between different maps,
# returning a set of contingence matrices that provide information about the level of agreement
# as well as telling the quantity, shift, exchange charactetistics of such changes
# it is designed to return some maps and contingency matrices
...
classified_map <- raster('your_classifiedmap.tif')


#you will need a shapefile of your study area. You can vectorize the mosaic or 
#any of the masks for that. Make sure 
...
# i needed to do this for some reason. 
Sys.setlocale(locale="C")

#create a list of succesive years
years <- list(2000:2020)
...
#simultaneously. It's way faster. You only limitation  is the available memory. 
...
#you will have to run for each one of the years. However we're lazy people and want the computer
# to work for us. So we are going to map the function to iterate for the whole *years* list. It returns a list 
