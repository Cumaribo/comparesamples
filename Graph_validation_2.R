...
l=1
test2_mapt1 <- (x=1:length(labels2))%>%map(function(x) data_prep(conf_mat[x]))
...
UA_all2 <- rbind(test2_mapt1[[j]][[2]],test2_mapt2[[j]][[2]],test2_mapt3[[j]][[2]],test2_mapt4[[j]][[2]],
                 test2_mapt5[[j]][[2]],test2_mapt6[[j]][[2]],test2_mapt7[[j]][[2]],test2_mapt8[[j]][[2]])
OA_all<- rbind(test2_mapt1[[j]][[3]],test2_mapt2[[j]][[3]],test2_mapt3[[j]][[3]],test2_mapt4[[j]][[3]],
                test2_mapt5[[j]][[3]],test2_mapt6[[j]][[3]],test2_mapt7[[j]][[3]],test2_mapt8[[j]][[3]])
...
names(OA_all) <- c("Accuracy",'region', 'Thresshold','cover')
...
jpeg(filename= 'Accu_UB.jpg', height=8, width = 8, units='in', res=75)
